...
registerOARFAS("RECT", ["GetWindowRect"], (args) => [["left"], ["top"], ["right"], ["bottom"]], {});
registerOARFAS("POINT", ["GetMousePos", "GetCursorPos", "getPosition"], (args) => [["x"], ["y"]], {});
registerOARFAS("PhysObj", [], (args) => GenericPhysObject(), {
...
registerOARFAS("Ball", ["Board.reloadGun", "createBall"], (args) => [...GenericPhysObject(), ["multiball"], ["x"], ["y"], ["velX"], ["velY"], ["drawX"], ["drawY"], ["radius"], ["anchored"], ["fireball"], ["idk"], ["destroy", vscode.CompletionItemKind.Method], ["method", vscode.CompletionItemKind.Method]], extendMethods("PhysObj", {
...
registerOARFAS("Poly", [], (args) => PolyObject(), extendMethods("PhysObj", {}));
registerOARFAS("Brick", [], (args) => PolyObject(), extendMethods("Poly", {}));
registerOARFAS("PegInfo", ["createPegInfo"], (args) => [...GenericPtrObject(), ["refCount"], ["type"], ["hit"], ["timeSinceHit"], ["hitCount"], ["animationPercent"], ["animationId"]], {
...
registerOARFAS("FloatingTextMgr", [], (args) => [["enumFloatingTextObjs", vscode.CompletionItemKind.Method]], {
...
registerOARFAS("WidgetManager", [], (args) => [["mouseX"], ["mouseY"], ["mouseButtons"], ["isKeyDown", vscode.CompletionItemKind.Method], ["arrowLeft"], ["arrowUp"], ["arrowRight"], ["arrowDown"]], {
...
registerOARFAS("Gun", [], (args) => [["lastRotation"], ["ballX"], ["ballY"], ["offsetX"], ["offsetY"], ["idkBruh"], ["offsetBallRadius"], ["setNewBall", vscode.CompletionItemKind.Method], ["ball", vscode.CompletionItemKind.Class]], {
...
registerOARFAS("SoundMgr", [], (args) => [["playSoundSimple", vscode.CompletionItemKind.Method]], {
